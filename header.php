                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <span class="badge badge-danger badge-counter" id="noti_count"></span>
                            </a>
                            <!-- Dropdown - Alerts -->
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                foreach ($result as $row):
                                 ?>
                                <a class="dropdown-item d-flex align-items-center" href="TaskView.php?tid=<?php echo $row['t_id']; ?>">
                                    <div class="mr-3">
                                    ...
                                    <div>
                                        <div class="small text-gray-500"> <?php echo  date('F d, Y',strtotime($row['date_time']))?></div>
                                        <span class="font-weight-bold"><?php echo $row['task_name']; ?></span>
                                    </div>
                                </a>
                               <?php endforeach; ?>

                                <a class="dropdown-item text-center small text-gray-500" href="/TaskNew.php">Show All Task</a>
                            </div>
                        </li>
