...
if(isset($_POST['login_submit'])){
    ...
    if(empty($user_mobile) OR empty($user_password)){
        ...
        $stm=$pdo->prepare("SELECT u_id,mobile,password FROM em_users WHERE mobile=?");
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="">
                                        <div class="form-group">
                                            <input type="text" name="user_mobile" class="form-control form-control-user" id="mobile" placeholder="Mobile Number">
                                        </div>
                                        <div class="form-group">
